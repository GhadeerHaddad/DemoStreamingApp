...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	var aa = __webpack_require__(1),
	    ...
	    r = __webpack_require__(6);function u(a) {
	...
	function ra() {
	  if (pa) for (var a in qa) {
	    var b = qa[a],
	        c = pa.indexOf(a);if (!(-1 < c)) throw Error(u(96, a));if (!sa[c]) {
	      if (!b.extractEvents) throw Error(u(97, a));sa[c] = b;c = b.eventTypes;for (var d in c) {
	        var e = void 0;var f = c[d],
	            g = b,
	            h = d;if (ta.hasOwnProperty(h)) throw Error(u(99, h));ta[h] = f;var k = f.phasedRegistrationNames;if (k) {
	          for (e in k) {
	            k.hasOwnProperty(e) && ua(k[e], g, h);
	          }e = !0;
	        } else f.registrationName ? (ua(f.registrationName, g, h), e = !0) : e = !1;if (!e) throw Error(u(98, d, a));
	      }
	    }
	  }
	}
	function ua(a, b, c) {
	  if (va[a]) throw Error(u(100, a));va[a] = b;wa[a] = b.eventTypes[c].dependencies;
	}var sa = [],
	    ta = {},
	    va = {},
	    wa = {};function xa(a) {
	  var b = !1,
	    ...
	    if (a.hasOwnProperty(c)) {
	      var d = a[c];if (!qa.hasOwnProperty(c) || qa[c] !== d) {
	        if (qa[c]) throw Error(u(102, c));qa[c] = d;b = !0;
	      }
	    }
	  }b && ra();
	...
	function Ca(a) {
	  if (a = ma(a)) {
	    if ("function" !== typeof za) throw Error(u(280));var b = a.stateNode;b && (b = la(b), za(a.stateNode, a.type, b));
	  }
	}function Da(a) {
	...
	"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function (a) {
	  ...
	  var b = a[0];C[b] = new v(b, 1, !1, a[1], null, !1);
	...
	"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function (a) {
	  var b = a.replace(Ua, Va);C[b] = new v(b, 1, !1, a, null, !1);
	});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function (a) {
	  var b = a.replace(Ua, Va);C[b] = new v(b, 1, !1, a, "http://www.w3.org/1999/xlink", !1);
	});["xml:base", "xml:lang", "xml:space"].forEach(function (a) {
	  var b = a.replace(Ua, Va);C[b] = new v(b, 1, !1, a, "http://www.w3.org/XML/1998/namespace", !1);
	});["tabIndex", "crossOrigin"].forEach(function (a) {
	  C[a] = new v(a, 1, !1, a.toLowerCase(), null, !1);
	});
	C.xlinkHref = new v("xlinkHref", 1, !1, "xlink:href", "http://www.w3.org/1999/xlink", !0);["src", "href", "action", "formAction"].forEach(function (a) {
	  C[a] = new v(a, 1, !1, a.toLowerCase(), null, !0);
	});var Wa = aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;Wa.hasOwnProperty("ReactCurrentDispatcher") || (Wa.ReactCurrentDispatcher = { current: null });Wa.hasOwnProperty("ReactCurrentBatchConfig") || (Wa.ReactCurrentBatchConfig = { suspense: null });
	function Xa(a, b, c, d) {
	...
	var ye = { change: { phasedRegistrationNames: { bubbled: "onChange", captured: "onChangeCapture" }, dependencies: "blur change click focus input keydown keyup selectionchange".split(" ") } };function ze(a, b, c) {
	  a = G.getPooled(ye.change, a, b, c);a.type = "change";Da(c);Xd(a);return a;
	}var Ae = null,
	...
	(function (a) {
	  var b = a.findFiberByHostInstance;return Yj(n({}, a, { overrideHookState: null, overrideProps: null, setSuspenseHandler: null, scheduleUpdate: null, currentDispatcherRef: Wa.ReactCurrentDispatcher, findHostInstanceByFiber: function findHostInstanceByFiber(a) {
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * This source code is licensed under the MIT license found in the
	 * LICENSE file in the root directory of this source tree.
	 */'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var _assign=__webpack_require__(5);var Scheduler=__webpack_require__(6);var checkPropTypes=__webpack_require__(10);var tracing=__webpack_require__(12);var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// Prevent newer renderers from RTE when used with older react package versions.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _movies = __webpack_require__(35);

	var _movies2 = _interopRequireDefault(_movies);

	var _series = __webpack_require__(37);

	var _series2 = _interopRequireDefault(_series);

	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../HomePage/home.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var Home = function (_Component) {
	  ...
	  _createClass(Home, [{
	    ...
	    key: "handleClickHome",
	    value: function handleClickHome(id) {
	      this.setState({
	        showing: true,
	        id: 'h'
	      });
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "div",
	            { id: "h", onClick: function onClick() {
	                return _this2.handleClickHome('h');
	              } },
	            _react2.default.createElement(_header2.default, null)
	          )
	        ),
	        _react2.default.createElement(_content2.default, { title: this.state.title }),
	        _react2.default.createElement(
	          "div",
	          { className: "content-home-card" },
	          _react2.default.createElement(
	            _reactRouterDom.Link,
	            { to: "/movies" },
	            _react2.default.createElement(
	              "div",
	              { id: "m", onClick: function onClick() {
	                  return _this2.handleClick('m');
	                } },
	              this.state.showing && _react2.default.createElement(_card2.default, { className: "content-card-item", caption: "Popular Movies" })
	            )
	          ),
	          _react2.default.createElement(
	            _reactRouterDom.Link,
	            ...
	            _react2.default.createElement(
	              "div",
	              { id: "s", onClick: function onClick() {
	                  return _this2.handleClick('s');
	                } },
	              this.state.showing && _react2.default.createElement(_card2.default, { className: "content-card-item", caption: "Popular Series" })
	            )
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          null,
	          _react2.default.createElement(_reactRouterDom.Route, { path: "/movies", exact: true, component: _movies2.default }),
	          _react2.default.createElement(_reactRouterDom.Route, { path: "/series", exact: true, component: _series2.default })
	        ),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../Header/header.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_button2.default, { id: 'login-button', className: 'login-button', buttonText: 'Log in' })
	      ),
	      _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          'button',
	          { id: 'trial-button', className: 'trial-button' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../Button/button.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./content.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var content = function content(props) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "h2",
	        { className: "content-title-header" },
	        props.title
	      )
	    )
	  );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../Footer/footer.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var footer = function footer(props) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_button2.default, { id: "home-button", className: "button-class", buttonText: "Home" }),
	      _react2.default.createElement(
	        "span",
	        { className: "footer-span" },
	        " | "
	      ),
	      _react2.default.createElement(_button2.default, { id: "terms-button", className: "button-class", buttonText: "Terms and Conditions" }),
	      _react2.default.createElement(
	        "span",
	        { className: "footer-span" },
	        " | "
	      ),
	      _react2.default.createElement(_button2.default, { id: "privacy-button", className: "button-class", buttonText: "Privacy Policy" }),
	      _react2.default.createElement(
	        "span",
	        { className: "footer-span" },
	        " | "
	      ),
	      _react2.default.createElement(_button2.default, { id: "collection-button", className: "button-class", buttonText: "Collection Statement" }),
	      _react2.default.createElement(
	        "span",
	        { className: "footer-span" },
	        " | "
	      ),
	      _react2.default.createElement(_button2.default, { id: "help-button", className: "button-class", buttonText: "Help" }),
	      _react2.default.createElement(
	        "span",
	        { className: "footer-span" },
	        " | "
	      ),
	      _react2.default.createElement(_button2.default, { id: "account-button", className: "button-class", buttonText: "Manage Account" })
	    ),
	    _react2.default.createElement(
	      "div",
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "small",
	          null,
	          " Copyright \xA9 DEMO Streaming. All rights reserved."
	        ),
	        " "
	      )
	    ),
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement("img", { className: "footer-media-item", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../Asset/images/facebookIcon.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), alt: "facebook icon" }),
	      _react2.default.createElement("img", { className: "footer-media-item", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../Asset/images/twitterIcon.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), alt: "twitter icon" }),
	      _react2.default.createElement("img", { className: "footer-media-item", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../Asset/images/instagramIcon.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), alt: "instagram icon" }),
	      _react2.default.createElement(
	        "div",
	        { className: "footer-stores" },
	        _react2.default.createElement("img", { className: "footer-stores-item", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../Asset/images/AppStore.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), alt: "App Store icon" }),
	        _react2.default.createElement("img", { className: "footer-stores-item", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../Asset/images/GooglePlayImage.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), alt: "Google Play icon" }),
	        _react2.default.createElement("img", { className: "footer-stores-item", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../Asset/images/MicrosoftBadge.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), alt: "Get it from Microsoft icon" })
	      )
	    )
	  );
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../Card/card.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var card = function card(props) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement("img", { className: "image-class", src: props.image, alt: props.altText })
	    ),
	    _react2.default.createElement(
	      "div",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../MoviesPage/movies.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var Movies = function (_Component) {
	  ...
	  _createClass(Movies, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      fetch("https://raw.githubusercontent.com/StreamCo/react-coding-challenge/master/feed/sample.json").then(function (data) {
	        return data.json();
	      }).then(function (json) {
	    ...
	    value: function render() {
	      ...
	      if (!isLoaded) {
	        ...
	        return _react2.default.createElement(
	          'div',
	          { className: 'movie-page-class' },
	          items.filter(function (item) {
	            return item.releaseYear >= 2010 && item.programType === "movie";
	          }).slice(0, 21).sort(function (a, b) {
	            return a.title > b.title ? 1 : -1;
	          }).map(function (i) {
	            return _react2.default.createElement(_card2.default, { className: 'movie-class', key: i.title, caption: i.title, image: i.images["Poster Art"].url, alt: i.title });
	          })
	        );
	      }
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../SeriesPage/series.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	    ...
	    _createClass(Series, [{
	        ...
	        value: function render() {
	            ...
	            if (!isLoaded) {
	                ...
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'series-page-class' },
	                    items.filter(function (item) {
	                        return item.releaseYear >= 2010 && item.programType === "series";
	                    }).slice(0, 21).sort(function (a, b) {
	                        return a.title > b.title ? 1 : -1;
	                    }).map(function (i) {
	                        return _react2.default.createElement(_card2.default, { className: 'series-class', key: i.title, caption: i.title, image: i.images["Poster Art"].url, alt: i.title });
	                    })
	                );
	            }
	        }
